...
| 2026-09-01 | Google Chrome 152.0.7977.65 (Playwright headless, `--enable-features=WebMCP --enable-blink-features=WebMCP`) | https://host-stand-nine.vercel.app (commit bce12da, after `set_plan` was added) | `document.modelContext` | 22 / 22 | Native pass and navigator-fallback pass repeated against production with the batch planning tool; STALE_STATE and INVALID_INPUT still round-trip. Earlier rows show 21 tools because they predate `set_plan`. |
